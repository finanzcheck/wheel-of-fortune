...
function WheelDirective(participantsService, winnersService, $timeout, $q, $location) {
    ...
    function WheelDirectiveController(scope) {
        ...
        function init() {
            ...
            var _wheel = new WheelOfFortune(scope, 800, 800, scope.participants, ngWheelContainer[0], function (a) {
                angles = a;
            });
...
function WheelOfFortune(scope, width, height, participants, container, callback) {
    var angle = 0,
        start = 0,
        total = 0,
        angles = [],
        ...
        process = function (participant) {
            var angleplus = 360 * participant.spokes / total,
                color = d3.hcl(start, 0.75, 1),
                bcolor = d3.hcl(start, 1, 1);
